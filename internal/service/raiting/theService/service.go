...
func (s *DummyServiceService) init() {
	s.Create(TheService{ServiceId: 1, Value: 5, UpdatedTs: timeToStr("2 January 2012 15:04")})
	s.Create(TheService{ServiceId: 1, Value: 5, UpdatedTs: timeToStr("2 January 2012 15:04")})
	s.Create(TheService{ServiceId: 2, Value: 4, UpdatedTs: timeToStr("3 January 2012 15:04")})
